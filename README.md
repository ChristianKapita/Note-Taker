...
This Project consist of note taker  application that allows user to save note with a title and plain text. User can select a given note by his name and delete it.
